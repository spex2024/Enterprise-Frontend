                    ...
                    {status === 'success' ? (
                        <div className={` flex flex-col justify-center items-center w-full `}>
                            ...
                            <div className="py-10 text-center w-full h-64 ">
                                <Link href={"/login"} >
                                    <button type="submit"
                                            className="  bg-gray-900 px-8 py-2 text-center text-base font-semibold text-white shadow-md transition">Login
                                    </button>
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className={`w-full flex flex-col justify-center items-center`}>
                            ...
                            <div className="py-10 text-center">
                                <Link href={"/ogin"} className="px-12 bg-black text-white font-semibold py-3">
                                    <button type="submit"
                                            className="  bg-gray-900 px-8 py-2 text-center text-base font-semibold text-white shadow-md transition">Login
                                    </button>
                                </Link>
                        ...
                        <div className={` py-16  flex-col justify-center items-center flex w-full`}>
                            ...
                            <p className="text-gray-600 my-2"> Please
